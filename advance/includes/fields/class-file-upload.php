...
class WPForms_Field_File_Upload extends WPForms_Field
{
    ...
    public function field_options($field)
    {
        ...
        $lbl = $this->field_element(
            ...
            array(
                ...
                'tooltip' => __('Enter the extensions you would like to allow, comma separated. Default is jpg', 'wpforms'),
            ),
            false
        );
        $fld = $this->field_element(
            ...
            array(
                'slug' => 'extensions',
                'value' => !empty($field['extensions']) ? $field['extensions'] : 'jpg,png,pdf,doc,docm,dotx,xlsx,xls,xlsm,xlt,xltx',
            ),
            false
        );
        $args = array(
    ...
    public function field_display($field, $deprecated, $form_data)
    {
        ...
        // Primary field.
        printf('<input ondragstart="return false;" ondrop="return false;" type="file" %s %s>',
