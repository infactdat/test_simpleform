...
class WPForms_Field_Address extends WPForms_Field
{
    ...
    public function init()
    {
        ...
        $this->schemes = apply_filters('wpforms_address_schemes', array(
            'us' => array(
                'label' => __('US', 'wpforms'),
                'address1_label' => __('Address code 1', 'wpforms'),
                'address2_label' => __('Address code 2', 'wpforms'),
            ...
            'international' => array(
                ...
                'address2_label' => __('Address code 2', 'wpforms'),
                'city_label' => __('City', 'wpforms'),
                'postal_label' => __('Street number', 'wpforms'),
                'state_label' => __('State / Province / Region', 'wpforms'),
                'states' => '',
                'country_label' => __('Custom address', 'wpforms'),
    ...
    public function field_options($field)
    {
        ...
        $scheme = !empty($field['scheme']) ? esc_attr($field['scheme']) : 'international';
        ...
        $this->field_element('label', $field, array(
            ...
            'value' => __('Address Line 1', 'wpforms'),
        ));
        ...
        $address2_hide = !empty($field['address2_hide']) ? false : false;
        ...
        $this->field_element('label', $field, array(
            ...
            'value' => __('Address Line 2', 'wpforms'),
        ));
        echo '<div class="placeholder">';
        ...
        $this->field_element('label', $field, array(
            ...
            'value' => __('State / Province / Region', 'wpforms'),
        ));
        echo '<div class="placeholder">';
        ...
        $this->field_element('label', $field, array(
            ...
            'value' => __('Street number', 'wpforms'),
        ));
        echo '<div class="placeholder">';
        ...
        $this->field_element('label', $field, array(
            ...
            'value' => __('Custom address', 'wpforms'),
        ));
        echo '<div class="placeholder">';
    ...
    public function field_preview($field)
    {
        ...
        $format = !empty($field['format']) ? esc_attr($field['format']) : 'international';
    ...
    public function field_display($field, $deprecated, $form_data)
    {
        ...
        echo '<div class="wrap_address">';
        echo '<div class="wpforms-field-row wrap_address1 wrap_address_keynumber">';
        ...
        echo '<label>〒</label>';
        printf('<input type="number"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  %s %s>',
        ...
        echo '</div>';
        echo '</div>';
        echo '<div class="line-through">-</div>';


        if (empty($address2['hidden'])) {

            // Row wrapper.
            echo '<div class="wpforms-field-row wrap_address2 wrap_address_keynumber">';
            echo '<div class="wpforms-field-row wpforms-field-' . sanitize_html_class($field['size']) . '">';
        ...
        // Row wrapper.
        echo '<div class="wpforms-field-row wpforms-one-third first wpforms-field-' . sanitize_html_class($field['size']) . '">';
        ...
        if (isset($this->schemes[$scheme]['states']) && isset($state['options'])) {
            echo '<div class="wpforms-field-row wpforms-one-third wpforms-field-' . sanitize_html_class($field['size']) . '">';
        ...
        if (empty($country['hidden']) || empty($postal['hidden'])) {
            // Row wrapper.
            echo '<div class="wpforms-field-row wpforms-one-third last wpforms-field-' . sanitize_html_class($field['size']) . '">';
            // Postal.
        ...
        <script>
            jQuery(document).ready(function () {
                // Auto generate address fields
                var address1 = "<?php echo $address1['attr']['name']; ?>",
                    address2 = "<?php echo $address2['attr']['name']; ?>",
                    prefecture = '<?php echo $state['attr']['name']; ?>',
                    city = '<?php echo $city['attr']['name']; ?>',
                    street = "<?php echo $postal['attr']['name']; ?>";



                jQuery("#<?php echo $field['properties']['container']['id']; ?> .wpforms-field-address-address1").attr('onKeyUp', 'AjaxZip3.zip2addr(this,\'\',\'address\',\'address\');');
                jQuery("#<?php echo $field['properties']['container']['id']; ?> .wpforms-field-address-address2").attr('onKeyUp', 'AjaxZip3.zip2addr(\'' + address1 + '\', \'' + address2 + '\',\'' + city + '\',\'' + prefecture + '\',\'' + street + '\');');
