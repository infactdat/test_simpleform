...
class WPForms_Builder {
	...
	public function load_panels() {
		...
		foreach ( $this->panels as $panel ) {
			...
			} elseif ( file_exists( WPFORMS_PLUGIN_DIR . 'advance/includes/admin/builder/panels/class-' . $panel . '.php' ) ) {
				require_once WPFORMS_PLUGIN_DIR . 'advance/includes/admin/builder/panels/class-' . $panel . '.php';
			}
		}
	}
	...
	public function enqueues() {
		...
		$strings = array(
			...
			'saved_state'            => '',
			'layout_selector_show'   => __( '', 'wpforms' ),
			...
			'embed_modal'            => __( 'Shortcode of this form', 'wpforms' ),
			'embed_modal_2'          => '',
			...
			'smart_tags_show'        => __( '', 'wpforms' ),
			'smart_tags_hide'        => __( '', 'wpforms' ),
			...
			<form name="wpforms-builder" id="wpforms-builder-form" method="post" data-id="<?php echo $form_id; ?>">
				...
				<div class="wpforms-toolbar">
					...
					<div class="wpforms-left">
						...
						<img src="<?php echo WPFORMS_PLUGIN_URL; ?>assets/images/logo.jpg" alt="Sullie WPForms mascot">
