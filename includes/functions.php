...
function wpforms_get_string_between( $string, $start, $end ) {
	$string = ' ' . $string;
...
function wpforms_debug_data( $data, $echo = true ) {
	...
	if ( wpforms_debug() ) {
		...
		$output = '<textarea style="background:#fff;margin: 20px 0;width:100%;height:500px;font-size:12px;direction: ltr;unicode-bidi: embed;line-height: 1.4;padding: 4px 6px 1px;" readonly>';
...
function check_smush_pro() {
	// Fix lỗi get_current_screen của WP Smush PRO
